...
import UserDistributionByRole from "./UserDistributionByRole";
import UserAccountCreationTrend from "./UserAccountCreationTrend";
import { useState } from "react";
import moment from "moment";
import UserAccountsSummary from "./UserAccountsSummary";
        ...
        <>
            ...
            <Container>
                ...
                <Grid2 mt={2} container size={12} spacing={1}>
                    <Grid2 size={6}>
                        <Card>
                            <Typography variant="h6" textAlign={"start"} p={1}>User distribution by role</Typography>
                            <Divider />
                    ...
                    <Grid2 size={6}>
                        <Card>
                            <Typography variant="h6" textAlign={"start"} p={1}>User account creation trend</Typography>
                            <Divider />
                            <UserAccountCreationTrend startDate={dateRange!.startDate} endDate={dateRange!.endDate} />
                        </Card>
                    </Grid2>
                </Grid2>
                <Card sx={{ mt: 2}}>
