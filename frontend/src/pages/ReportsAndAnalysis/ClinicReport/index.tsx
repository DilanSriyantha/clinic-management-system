...
import ClinicAppointmentDistribution from "./ClinicAppointmentDistribution";
import ClinicPatientRegistrationTrend from "./ClinicPatientRegistrationTrends";
        ...
        return (
            <>
                <Grid2 mt={2} container size={12} spacing={1}>
                    <Grid2 size={6}>
                        <Card>
                            <Typography variant="h6" textAlign={"start"} p={1}>Appointment distribution</Typography>
                            <Divider />
                            <ClinicAppointmentDistribution
                    ...
                    <Grid2 size={6}>
                        <Card>
                            ...
                            <Divider />
                            <ClinicPatientRegistrationTrend
                                startDate={dateRange.startDate}
                                endDate={dateRange.endDate}
                            />
                        </Card>
            ...
            <>
                ...
                >
                    <Container sx={{ bgcolor: "white" }}>
                        <Card>
                            <Typography variant="h3">Clinic Report</Typography>
